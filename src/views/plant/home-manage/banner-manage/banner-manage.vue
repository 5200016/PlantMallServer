<style lang="less">
    @import "banner-manage";
</style>

<template>
    <div class="banner-manage">
        <Button class="add-button" type="primary" @click="insertBanner">新增轮播图</Button>
...
<script>
    ...
    import * as bannerRequest from '../../../../request/home-manage/banner-manage'
